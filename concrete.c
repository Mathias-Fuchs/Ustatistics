...
int main(int argc, char ** argv) {
	...
	size_t n = 103; // sample size
	size_t p = 3; // number of features in the dataset


	int B = 2.5e6; // number of resampling iterations in each U-statistic
	int seed = 1234;
	...
	for (int g = 30; g < 41; g++) {
		...
		*/
		...
		printf("g: %i, leave-p-out-estimator %f, t2: %f, square of estimated variance of lpo: %f\n", g, lpo, t2, gsl_pow_2(lpo) - t2);
	}
	return 0;
}
